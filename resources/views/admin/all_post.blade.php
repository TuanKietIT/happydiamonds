      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><img src="public/upload/member/{{$post->post_image}}" height="100px" width="100px" alt=""></td>
            <td>{{$post->post_meta_dest}}</td>
            <td>
              ...
              <a onclick="return confirm('Bạn có chắc là muốn xóa danh mục này?')" href="{{URL::to('/delete-post/'.$post->post_id)}}" title="">
